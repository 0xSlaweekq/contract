...
contract('Moloch', ([creator, summoner, applicant1, applicant2, processor, delegateKey, nonMemberAccount, ...otherAccounts]) => {
  ...
  describe('constructor events', () => {
    ...
    it('require success - emits SummonComplete event', async () => {
      ...
      const { tokens, summoningTime, periodDuration, votingPeriodLength, gracePeriodLength, proposalDeposit, dilutionBound, processingReward } =
        log.args;
  ...
  describe('submitWhitelistProposal events', () => {
    ...
    it('require success - emits SubmitProposal event submitted by non-member', async () => {
      ...
      const emittedLogs = await moloch.submitWhitelistProposal(newToken.address, 'whitelist me!', { from: proposal1.applicant });
    ...
    it('require success - emits SubmitProposal event submitted by member', async () => {
      ...
      const emittedLogs = await moloch.submitWhitelistProposal(newToken.address, 'whitelist me!', { from: summoner });
    ...
    it('require success - emits SubmitProposal event submitted by delegate', async () => {
      ...
      const emittedLogs = await moloch.submitWhitelistProposal(newToken.address, 'whitelist me!', { from: processor });
  ...
  describe('submitGuildKickProposal events', () => {
    ...
    it('require success - emits SubmitProposal event submitted by non-member', async () => {
      ...
      const emittedLogs = await moloch.submitGuildKickProposal(guildKickProposal.applicant, guildKickProposal.details, { from: nonMemberProposer });
    ...
    it('require success - emits SubmitProposal event submitted by member', async () => {
      ...
      const emittedLogs = await moloch.submitGuildKickProposal(guildKickProposal.applicant, guildKickProposal.details, { from: proposer });
  ...
  describe('sponsorProposal events', () => {
    ...
    it('require success - emits SponsorProposal event for guildKickProposal', async () => {
      ...
      await moloch.submitGuildKickProposal(guildKickProposal.applicant, guildKickProposal.details, { from: proposer });
  ...
  describe('rageQuit events', () => {
    ...
    it('require success - partial ragequit - emits RageQuit event', async () => {
      ...
      const amountToRagequit = Math.floor(
        (partialRageQuitShares * proposal1.tributeOffered) / (proposal1.sharesRequested + proposal1.lootRequested + 1)
      );
