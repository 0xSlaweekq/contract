...
contract DividendDistributor is IDividendDistributor, ReentrancyGuard {
    ...
    IBEP20 EP = IBEP20(0x0755FA2F4AA6311E1D7C19990416c86F17D16F86); // reward address ETHP
    address WETH = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    IDEXRouter router;
    ...
    constructor(address _router) {
        router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        _token = msg.sender;
    }
...
contract ETHPP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x0755FA2F4AA6311E1D7C19990416c86F17D16F86; // reward ETHP
    address public WETH = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ETHPP";
    ...
    address public autoLiquidityReceiver = 0xe67f37A50C404f4685D7550Ffbcde75a7D9c656B; //liq address
    address public marketingFeeReceiver = 0xe67f37A50C404f4685D7550Ffbcde75a7D9c656B; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 50; // 0.25%
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
    ...
    function getMultipliedFee() public view returns (uint256) {
        /**
        if (launchedAtTimestamp + 1 days > block.timestamp) return totalFee.mul(18000).div(feeDenominator);
