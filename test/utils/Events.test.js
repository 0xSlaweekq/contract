import { artifacts, ethereum, web3 } from 'hardhat';
  ...
  ([
    ...
    describe('constructor events', () => {
      ...
      it('require success - emits SummonComplete event', async () => {
        ...
        const logs = await newContract.getPastEvents('allEvents', {
    ...
    describe('sponsorProposal events', () => {
      beforeEach(async () => {
        ...
        await verifyBalance({
          ...
          address: summoner,
          expectedBalance:
            initSummonerBalance + deploymentConfig.PROPOSAL_DEPOSIT + proposal1.tributeOffered
        });
      ...
      it('require success - emits SponsorProposal event for proposal', async () => {
        ...
        await verifyBalance({
          ...
          address: summoner,
          expectedBalance:
            deploymentConfig.PROPOSAL_DEPOSIT + initSummonerBalance + proposal1.tributeOffered
        });
      ...
      it('require success - emits SponsorProposal event for whitelistProposal', async () => {
        ...
        await moloch.submitWhitelistProposal(newToken.address, 'whitelist me!', { from: summoner });
      ...
      it('require success - emits SponsorProposal event for guildKickProposal', async () => {
        ...
        await verifyBalance({
          ...
          address: summoner,
          expectedBalance:
            initSummonerBalance + proposal1.tributeOffered + deploymentConfig.PROPOSAL_DEPOSIT
        });
    ...
    describe('processWhitelistProposal events', () => {
      ...
      it('require success - yes wins - emits ProcessWhitelistProposal event', async () => {
        ...
        const emittedLogs = await moloch.processWhitelistProposal(firstProposalIndex, {
          from: processor
        });
      ...
      it('require success - yes wins - emits ProcessGuildKickProposal event', async () => {
        ...
        await verifySubmitVote({
          ...
          expectedMaxSharesAndLootAtYesVote:
            summonerShares + proposal1.lootRequested + proposal1.sharesRequested,
          expectedVote: yes
        });
        ...
        const emittedLogs = await moloch.processGuildKickProposal(secondProposalIndex, {
          from: processor
        });
        ...
        await verifyInternalBalances({
          ...
          userBalances: {
            ...
            [ESCROW]: 0,
            [summoner]:
              2 * (deploymentConfig.PROPOSAL_DEPOSIT - deploymentConfig.PROCESSING_REWARD),
    ...
    describe('rageQuit events', () => {
      ...
      it('require success - full ragequit - emits RageQuit event', async () => {
        const emittedLogs = await moloch.ragequit(
          proposal1.sharesRequested,
          proposal1.lootRequested,
          { from: proposal1.applicant }
        );
      ...
      it('require success - partial ragequit - emits RageQuit event', async () => {
        ...
        const emittedLogs = await moloch.ragequit(partialRageQuitShares, 0, {
          from: proposal1.applicant
        });
        await verifyMember({
          moloch: moloch,
        ...
        assert.equal(
          totalShares,
          proposal1.sharesRequested - partialRageQuitShares + summonerShares
        );

        const amountToRagequit = Math.floor(
          (partialRageQuitShares * proposal1.tributeOffered) /
            (proposal1.sharesRequested + proposal1.lootRequested + 1)
        );
    ...
    describe('withdraw events', async () => {
      beforeEach(async () => {
        ...
        await moloch.ragequit(proposal1.sharesRequested, proposal1.lootRequested, {
          from: proposal1.applicant
        });
      ...
      it('require success - partial withdraw - emits Withdraw event', async () => {
        ...
        const emittedLogs = await moloch.withdrawBalance(depositToken.address, withdrawAmount, {
          from: proposal1.applicant
        });
    ...
    describe('cancelProposal events', () => {
      ...
      it('require success - emits CancelProposal event by member', async () => {
        const emittedLogs = await moloch.cancelProposal(firstProposalIndex, {
          from: proposal1.applicant
        });
      ...
      it('require fails -  CancelProposal reverts if cancelled by new delegate', async () => {
        ...
        const emittedLogs = await moloch
          .cancelProposal(firstProposalIndex, { from: processor })
