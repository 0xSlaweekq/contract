...
//  Stealth Launch
//  Telegram: https://t.me/avaxfudtoken
//  ONLY FUD IS ALLOWED
//  BUY AND HOLD TO GET AVAX REWARD
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // reward address avax
...
contract FUDTOKEN is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // reward avax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FUD TOKEN";
    string constant _symbol = "FUD";
    ...
    address public autoLiquidityReceiver=0x28BCe43144Fed3d1Cad806914Ba2FE19227d9196; //liq address
    address public marketingFeeReceiver=0x28BCe43144Fed3d1Cad806914Ba2FE19227d9196; // marketing address
