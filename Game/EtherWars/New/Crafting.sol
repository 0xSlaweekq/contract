...
contract Gem is ERC721A, Ownable, Pausable {
    uint256 private constant MAX_SUPPLY = 4995;
...
contract CraftGem is ERC721A, Ownable {
    ...
    function mutate(uint256[] calldata _gemIds) external payable {
        ...
        for (uint256 i = 0; i < _gemIds.length; ++i) {
            require(gemContract.ownerOf(_gemIds[i]) == msg.sender, 'Not gem owner');
        ...
        gemContract.transferFrom(msg.sender, 0x000000000000000000000000000000000000dEaD, _gemIds[2]);
