...
contract ForceNFT is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    IERC20 public Token = IERC20(0xA29264F0Fd9B31A7060686594fF87E6d9467c267);
    ...
    function getStolenNFTs() external view returns (uint256[] memory) {
        return stolenNFTs;
    }

    function mint(uint256 _amount) external payable {
        require(_circulatingSupply < 20000, "All tokens were minted");
        ...
        } else if (_circulatingSupply >= 5000 && _circulatingSupply < 10000) {
    ...
    function changeBaseExtension(string memory _newBaseExtension) external onlyOwner {
