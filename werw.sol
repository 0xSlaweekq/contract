...
contract Piggy is Context, IERC20, MarketingOwned {
    ...
    uint256 private _totalSupply = 10 *  10**7 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply.div(1); 
    uint256 public _walletMax = _totalSupply.div(1);
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newDevelopmentTax) external onlyOwner() {
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newDevelopmentShare) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBDevelopment = amountReceived.sub(amountBNBLiquidity);
